...
import AddDicDialog from './component/addDic.vue';
import { ElMessageBox } from 'element-plus';
import addDictItemDialogVue from './component/addDictItemDialog.vue';
...
export default {
	...
	components: {
		...
		ProButtons,
		AddDicDialog,
		addDictItemDialogVue,
	},
	setup() {
		const message = getCurrentInstance()?.appContext.config.globalProperties.$message;
		const proTableRef = ref(null);
		const addDicDialog = ref(null);
		const addDictItemRef = ref(null);
