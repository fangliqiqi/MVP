<template>
	<div class="operate-log-container">
		<el-dialog title="操作日志" v-model="state.isShowDialog" :close-on-click-modal="false" width="1216px" @close="closeDialog">
			<pro-table ref="proTableRef" row-key="id" :columns="state.columns" :request="request" :showHeader="false"  manualRequest tableExpand>
...
<style lang="scss" scoped src="./css/operateLog.scss"></style>
