	...
	<div class="home-container">
				...
				<div class="home-card-item flex">
					<div class="flex-margin flex w100" :class="` home-one-animation${k}`">
						...
						<div class="home-card-item-icon flex" :style="{ background: `var(${v.color2})` }">
							<em class="iconfont flex-margin font32" :class="v.num4" :style="{ color: `var(${v.color3})` }"></em>
						</div>
					</div>
				</div>
			</el-col>
		...
		<el-row :gutter="15" class="home-card-three">
			<el-col :xs="24" :sm="10" :md="10" :lg="8" :xl="8">
				<div class="home-card-item">
					<div class="home-card-item-title">员工数据</div>
					<div class="home-monitor">
						<div class="flex-warp">
							<div class="flex-warp-item" v-for="(v, k) in state.homeThree" :key="k">
								<div class="flex-warp-item-box" :class="`home-animation${k}`">
									<div class="flex-margin">
										<em :class="v.icon" :style="{ color: v.iconColor }"></em>
...
const initLineChart = () => {
	...
	const option = {
		...
		legend: { data: ['预成交量', '最新成交价'], right: 0 },
		xAxis: {
...
const initPieChart = () => {
	...
	let getname = ['皖信人力资源管理有限公司', '易服智享信息科技有限公司', '芜湖分公司', '六安分公司', '其他分公司'];
		...
		series: [
			...
			},
			{
				...
				data: [
					...
					{ value: 66, stationName: 's4' },
					{ value: 73, stationName: 's5' },
					{ value: 100, stationName: 's6' },
				],
			},
