<template>
	<div class="attach-info section-container">
		...
		<template v-if="state.collapse">
			<el-tabs v-model="state.attachActiveTab" type="card" class="attach-tabs" style="margin-top: 16px">
...
const state = reactive({
	...
	educationDetailConf: [
		...
		{ label: '证书名称', key: 'certificationName' },
	...
	disabilityDetailConf: [
		{ label: '员工姓名', key: 'empName' },
		{ label: '身份证号', key: 'empIdcard' },
		{ label: '伤残病名称', key: 'disabilityName' },
		{ label: '职业病名称', key: 'occupationalDisease' },
	...
	professionalDetailConf: [
		{ label: '员工姓名', key: 'empName' },
		{ label: '身份证号', key: 'empIdcard' },
		{ label: '证书编号', key: 'certificationNo' },
		{ label: '申报年度', key: 'declareYear' },
		{ label: '评定机构', key: 'assessmentUnit' },
...
<style lang="scss" scoped src="./css/attachSection.scss"></style>
