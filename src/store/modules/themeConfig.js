...
const themeConfigModule = {
	...
	state: {
		themeConfig: {
			...
			// 默认分栏菜单背景颜色
			columnsMenuBar: '#41484F',
			// 默认分栏菜单字体颜色
			columnsMenuBarColor: '#AEB6C0',
			// 是否开启分栏菜单背景颜色渐变
			...
			globalTitle: '业务云系统',
			// 网站副标题（登录页顶部文字）
			globalViceTitle: 'HRO管理系统',
			// 默认全局组件大小，可选值"<large|'default'|small>"，默认 'large'
			globalComponentSize: 'large',

			limitTagNumber: 10, // 可打开的最大tag个数，暂定10个，可后期根据需求修改，和路由缓存相关,add by hfcai,设置0则不控制最大tag数，且路由最多缓存20个
		},
	},
	mutations: {
		// 设置布局配置
